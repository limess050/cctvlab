...
<table class="form">
<tr>
<td><div class="f_title"><?=lang('brands_name');?> *</div><input type="text" name="brands_name"  value="<?=set_value('brands_name');?>" class="text" /></td>
</tr>
<tr>
<td><div class="f_title"><?=lang('manager_on_site');?></div><input type="checkbox" name="brands_active" value="1"  <?=set_checkbox('brands_active','1',TRUE);?> /></td>
</tr>
<tr>
